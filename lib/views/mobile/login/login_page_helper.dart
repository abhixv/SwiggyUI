...
class LoginPageHelper with ChangeNotifier {
  ...
  Container phoneNumberTextField(
  ...
  Widget loginButton(BuildContext context,
      TextEditingController phoneNumberController, bool valueFirst) {
    return InkWell(
      borderRadius: BorderRadius.circular(10),
      onTap: () {
        Provider.of<Authentication>(context, listen: false)
            .login(phoneNumberController, context);
        // Navigator.push(
        //     context,
        //     PageTransition(
